...
:root {
  --primary-color: #2B79C3;
  --secondary-color: #C8DFF0;
  --bg-primary-color: #FFF;
  --bg-secondary-color: #F0F0F0;
  --bg-input-color: #E4E4E4;
  --border-color: #3B4651;
  --text-dark-color: #3B4651;
...
<!-- <template>
  <header>
    <img alt="Logo" class="logo" src="./img/logo.png" width="125" height="125" />
